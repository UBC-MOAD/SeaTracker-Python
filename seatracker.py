...
class SeaTracker:
    ...
    def setup(self):
        ...
        self._u_field = _ModelField(self.u_field_file)
        self._v_field = _ModelField(self.v_field_file)
        ...
        self._w_field = _ModelField(self.w_field_file)
        ...
        self._e3w_field = _ModelField(self.ssh_field_file)
